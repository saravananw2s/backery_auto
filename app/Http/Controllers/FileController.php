...
// die();
    ...
    public static function base2image($data, $type)
    {
        ...
        // return Storage::disk('s3')->url(Base::db_connection().'/'.$filepath);

       return 'http://delivery.manageteamz.com/api/uploads/' . Base::db_connection() . '/' . $filepath;
    ...
    public static function store($file)
    {
        ...
        $path = 'http://delivery.manageteamz.com/api/' . $file->store('uploads/' . Base::db_connection());
        return $path;
    }
