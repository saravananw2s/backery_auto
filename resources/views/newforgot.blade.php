...
<div class="main">
 ...
 <div class="col-md-10" ng-controller="SignUpCtrl" style="background: white">
  <h4 class="form-header text-center"  >Delivery Account Recovery</h4>



<form class="md-form-auth form-validation" name="data_form1" ng-submit="resendEmail()" novalidate="">
    <div class="form-group float-label-control">
        <label for="">
            Email
        </label>
        <input class="form-control" name="email" ng-model="data.email" placeholder="Email"  required="" type="email"/>
        <span class="glyphicon glyphicon-envelope form-control-feedback">
        </span>
    </div>

    <span class="validationSpan" ng-if="data_form1.email.$invalid && (data_form1.$submitted  || data_form1.email.$touched )">
Email  required
</span>
...
Password  required
    ...
    <p style="color:red">
        ...
        <div class="form-group text-center col-md-12 row" >
        <div class="col-md-6">
            <a href="//delivery.manageteamz.com/dashboard/register">
        Create Account
     ...
     <div class="col-md-6">
            <a href="//delivery.manageteamz.com/dashboard/login">
    ...
    $scope.login = function() {
                ...
                $http.post($scope.App_url+'api/auth?api=web', {
                    ...
                    if (res.status === 'ok') {
                        ...
                        window.location=$scope.App_url+'#/app/user';
                    } else {
                        localStorageService.remove("apitoken");
                        if (res.data instanceof Array) {
                            $scope.alert = res.data[0];
