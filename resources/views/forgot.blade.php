    ...
    <div class="main-body">
        <div class="card bg-white">
            <div class="card-content" style="    padding: 0 !important" data-ng-controller="SignUpCtrl">
                ...
                <h5 style="">Delivery Account Forgot Password</h5>
                <form class="md-form-auth form-validation" name="material_login_form" ng-submit="ForgotPassword()" style="padding-bottom: 7%;">
                    <fieldset>
                        <md-input-container class="md-block">
                            ...
                            <div multiple="" ng-if="material_login_form.email.$dirty" ng-messages="material_login_form.email.$error">
                        ...
                        <md-button class="md-raised pull-right md-primary"  ng-disabled="submit" type="submit">
                            Forgot Password
                        </md-button>
                    </fieldset>
                </form>
