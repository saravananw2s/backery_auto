...
<div class="main">
 ...
 <!-- Sign up -->
  <div class="row  nopad bg-overlay " >

  <div class="col-md-12 mar6 pad40" style="    margin-bottom: 6%;">


  <div class="col-md-5 col-md-offset-4" >
 <div class="col-md-10" ng-controller="SignUpCtrl" style="background: white">
  <h4 class="form-header text-center"  >Delivery Account Login</h4>



<form class="md-form-auth form-validation" name="data_form1" ng-submit="login()" novalidate="">
    <div class="form-group float-label-control">
        <label for="">
            Email
        </label>
        <input class="form-control" name="email" id="login-email" ng-model="data.email" placeholder="Email"  required="" type="email"/>
        <span class="glyphicon glyphicon-envelope form-control-feedback">
        </span>
    </div>

    <span id="email-error" class="validationSpan" ng-if="data_form1.email.$invalid && (data_form1.$submitted  || data_form1.email.$touched )">
Email  required
</span>
...
Password  required
    ...
    <p style="color:red" id="custom-errors">
        ...
        <div class="form-group text-center row col-md-12">
            <div>
                <button class="btn btn-lg btn-lg btn-block btn-primary bton" type="submit" id="login-button">
                   Login
                </button>
            </div>
        </div>
        ...
        <div class="col-md-12">
        <div class="col-md-6">
            <a href="//delivery.manageteamz.com/dashboard/register" id="create-link">
        Create Account
     ...
     <div class="col-md-6">
            <a href="//delivery.manageteamz.com/dashboard/forgot" id="forgot-link">
