(function() {
    ...
    angular.module('app')
        .controller('CompetitorCtrl', ['$rootScope', '$state', '$stateParams', '$mdToast', '$timeout', '$scope', '$mdEditDialog', '$q', '$http', '$mdDialog', 'api', CompetitorCtrl])


    function CompetitorCtrl($rootScope, $state, $stateParams, $mdToast, $timeout, $scope, $mdEditDialog, $q, $http, $mdDialog, api) {
        ...
        $scope.view = function(id) {
            ...
            $state.go('admin.competitorview', { id: api.encode(id) });
        }
        ...
        $scope.title = 'Competitor';
        $scope.apipath = 'competitor/';
        $scope.showform = false;
        $scope.add = true;
        $scope.data = {};
