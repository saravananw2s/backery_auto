angular.module('app').directive('myCountry', [function($http) {
    return {
        priority: 0,
        restrict: 'E',
        replace: true,
...
angular.module('app')
    .directive('mdCountry', [function($http) {
        return {
            priority: 0,
            restrict: 'E',
            replace: true,
...
angular.module('app').directive('mdState', [function() {
    return {
        restrict: 'E',
        template: '<md-select aria-label=select name=state_id required><md-option ng-repeat="state in states track by $index" value={{state.id}}>{{state.state_name}}</md-option></md-select>',
        controller: function($scope, $element, $attrs, $transclude, $http) {
...
angular.module('app').directive('mdCity', [function() {
    return {
        restrict: 'E',
