(function() {
    ...
    angular.module('app')
        .controller('ProspectCtrl', ['$rootScope', '$state', '$stateParams','$mdToast', '$timeout', '$scope', '$mdEditDialog', '$q', '$http', '$mdDialog', 'api', ProspectCtrl])


    function ProspectCtrl($rootScope, $state, $stateParams, $mdToast, $timeout, $scope, $mdEditDialog, $q, $http, $mdDialog, api) {
        ...
        $scope.title = 'Prospect Type';
        $scope.apipath = 'prospect/';
        $scope.showform = false;
        $scope.add = true;
        $scope.data = {};
