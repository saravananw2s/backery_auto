(function() {
    'use strict';
    angular.module('app').controller('CustomerCtrl', ['$rootScope', '$state', '$stateParams', '$mdToast', '$timeout', '$scope', '$mdEditDialog', '$q', '$http', '$mdDialog', 'api', CustomerCtrl])
